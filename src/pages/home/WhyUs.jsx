...
const reasons = [
  {
    ...
    desc: "Every doctor on our platform is board-certified, background-checked, and peer-reviewed. Your safety is our first promise.",
  ...
  },
  {
    ...
    desc: "Skip the waiting room. Book same-day or next-day slots with top specialists in under 60 seconds, 24/7.",
  ...
  },
  {
    ...
    desc: "Choose how you want to be seen — secure HD video consultations from home or walk-in at any of our 120+ partner clinics.",
  ...
  },
  {
    ...
    title: "Insurance & Easy Payments",
    desc: "We accept 200+ insurance plans and offer flexible payment options including EMI, so costs never block your care.",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {reasons.map((r, i) => (
              ...
              >
                ...
                <div
                  className={`why-card-bar absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r ${r.gradient}`}
                  style={{
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
            <div>
              ...
              <p className="font-nunito text-gray-400 text-base mt-4 max-w-lg leading-relaxed">
                From routine check-ups to complex procedures — our network spans{" "}
                <span className="text-teal-300 font-semibold">
                  20+ medical specialties
                </span>{" "}
                with 320+ certified specialists ready to serve you.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="font-nunito text-gray-400 text-sm">
                Talk to our care coordinator — we'll match you with the right
