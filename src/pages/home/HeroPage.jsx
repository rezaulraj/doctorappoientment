...
const stats = [
  ...
  { value: "320+", label: "Expert Doctors" },
...
const doctors = [
  ...
  },
  {
    ...
    name: "Dr. Priya Nair",
    specialty: "Ophthalmologist ⭐ 4.9",
    slot: "Tomorrow 10 AM",
    avatar:
      "https://images.unsplash.com/photo-1527613426441-4da17471b66d?auto=format&fit=crop&w=100&q=80",
  },
];
...
export default function HeroPage() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      goTo((currentDoctor + 1) % doctors.length);
    }, 3000);
    return () => clearInterval(timer);
  }, [currentDoctor]);

  function goTo(index) {
    if (index === currentDoctor || transitioning) return;
    ...
    <>
      <style>{`
        ...
        .search-bar {
          ...
          box-shadow: 0 4px 24px rgba(13,148,136,.08), 0 1px 3px rgba(0,0,0,.04);
        }
        ...
        /* Floating card slide-in on doctor change */
        .float-card-animate {
          transition: opacity 0.35s ease, transform 0.35s ease;
        }
        .float-card-hidden {
          ...
          <div className="grid lg:grid-cols-2 gap-14 lg:gap-8 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                in minutes. Book appointments, get expert diagnoses, and receive
                personalised care — all from home.
              </p>

              <div className="search-bar flex flex-col sm:flex-row gap-3 p-2 rounded-2xl max-w-xl">
                <div className="flex items-center gap-2 flex-1 px-3">
                  ...
                  <input
                    ...
                    className="font-nunito flex-1 outline-none bg-transparent text-gray-700 placeholder-gray-400 text-sm py-2"
                  />
                </div>
                ...
                <button
                  className="font-nunito font-bold text-white px-6 py-3 rounded-xl text-sm whitespace-nowrap btn-gradient"
                  style={{
            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              <div className="relative">
                ...
                {/* ── Main doctor image with fade transition ── */}
                <div
                ...
                >
                  <img
                    ...
                    src={doc.src}
                    alt={doc.name}
                    className={`doctor-img w-full h-full object-cover object-top ${transitioning ? "fade-out" : "fade-in"}`}
                  />
                ...
                {/* ── Floating card 1 — Doctor info (updates with carousel) ── */}
                <div
                  className={`glass-card card-hover absolute -left-5 sm:-left-14 top-10 rounded-2xl p-3 min-w-[162px] z-20 float-card-animate ${transitioning ? "float-card-hidden" : "float-card-visible"}`}
                >
